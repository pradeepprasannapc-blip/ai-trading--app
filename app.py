...
if not df.empty and len(df) > 35:
    ...
    st.info("💡 **සටහන:** පහත ප්‍රස්ථාරයෙන් (Chart) සජීවී මිල පරීක්ෂා කර, AI නිර්දේශිත Entry මිලට Limit Order එකක් සකසන්න.")
    ...
    # --- 8. VISUAL TARGET SYNC PANEL (දැන් ප්‍රස්ථාරයට පහළින් ඇත) ---
    st.write("---")
    if has_valid_signal:
